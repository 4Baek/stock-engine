  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: '그래프 신호(밴드 위치/추세/거래량/리스크)로 계산된 손익비를 최종 적용할 때 범위를 제한합니다.',
        impact: '이 값 자체가 목표를 직접 결정하지 않고, 원시 손익비가 너무 크거나 작을 때 상·하한으로만 작동합니다. 즉 추천은 신호 기반, 최소/최대는 안전 범위 역할입니다.',
        glossary: [
          '손익비(R:R): 기대수익/허용손실 비율입니다.',
          '클램프(Clamp): 계산값이 범위를 넘지 않도록 상한/하한으로 제한하는 처리입니다.',
        ],
      },
    ],
  },
