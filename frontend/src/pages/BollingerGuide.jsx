...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: '손절(%) (stop_loss_pct)',
        key: '1 ~ 30 (기본 5)',
        description: '추천 카드의 손절가 계산에 사용됩니다.',
        impact: '점수에는 직접 영향이 없고 손절 기준가만 바뀝니다. 값이 작을수록 손절가가 현재가에 가까워집니다.',
        glossary: [
          '손절: 손실이 커지기 전에 미리 정한 가격에서 정리하는 규칙입니다.',
          '리스크 관리: 손실 한도를 통제해 계좌 변동을 줄이는 방법입니다.',
        ],
      },
      {
        name: '익절(%) (take_profit_pct)',
        key: '1 ~ 50 (기본 12)',
        description: '추천 카드의 익절가 계산에 사용됩니다.',
        impact: '점수에는 직접 영향이 없고 익절 기준가만 바뀝니다. 값이 클수록 목표가가 멀어집니다.',
        glossary: [
          '익절: 이익을 확정하기 위해 목표 가격에서 매도하는 규칙입니다.',
          '목표가: 수익 실현을 계획한 가격 수준입니다.',
        ],
      },
    ],
  },
