  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        name: '손익비 계산 방식 (R:R)',
        key: '자동 계산',
        description: '손익비는 밴드 위치, 돌파 강도, 추세, 거래량, 하단 이탈 리스크를 종합해 자동 계산됩니다.',
        impact: '사용자가 범위를 직접 고정하지 않아도 종목별 그래프 상황에 맞춰 손익비가 달라집니다. 즉 설정값보다 차트 신호를 우선 반영합니다.',
        glossary: [
          '손익비(R:R): 기대수익/허용손실 비율입니다.',
          '신호 기반 계산: 지표/가격 위치에서 나온 수치를 합성해 값을 산출하는 방식입니다.',
        ],
      },
    ],
  },
